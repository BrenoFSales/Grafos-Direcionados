...
func grauTotal(w http.ResponseWriter, r *http.Request, conjunto *conjunto) {

	resp := map[string]int{"grau_total": conjunto.GrafoGrau()}
...
func main() {
	...
	http.HandleFunc("/grau-total/{conjunto}", buscarConjuntoMiddleware(grauTotal))
